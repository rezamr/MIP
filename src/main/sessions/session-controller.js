...
const transitionTable = {
  [DRAFT]: [TARGET_ASSIGNED, ABORTED, INTEGRITY_FAILED],
  [TARGET_ASSIGNED]: [READY, ABORTED, INTEGRITY_FAILED],
  [READY]: [COMMITTED, ABORTED, INTEGRITY_FAILED],
  ...
  [AUDIO_READY]: [RUNNING, ABORTED, INTEGRITY_FAILED],
  [RUNNING]: [
    RETURNED,
    AUDIO_FAILED,
    TIMING_DEVIATION,
